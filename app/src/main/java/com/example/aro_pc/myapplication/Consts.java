...
public class Consts {
    ...
    public static final String USER_MODEL_USERNAME = "userName";
    ...
    public static final String LONGITUDE_JSON = "Lng:";

    //database recorder
    public static final String START_LISTEN = "start";
    public static final String STOP_LISTEN = "stop";
