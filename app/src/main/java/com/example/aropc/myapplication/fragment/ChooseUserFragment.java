...
import com.example.aropc.myapplication.adapter.AllUsersAdapter;
...
//        UserHelper.getInstance().setmUser(userModel);
    ...
    private void getAllUsers() {
        final String mUid = UserApp.readFromFile(getActivity().getApplicationContext(),Consts.FILE_NAME_UID);
